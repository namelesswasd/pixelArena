...
if(position_meeting(mouse_x, mouse_y, obj_bBackM)){
	image_index = 1;
	audioC++;
	if(tog == 0){
...
if(position_meeting(mouse_x, mouse_y, obj_bBackM) and mouse_check_button_pressed(mb_left)){
	//audio_play_sound(snd_clickMenu, 0, false);
	global.profileMenuToggle = 0;
	obj_hudMenu.menuSelect = 0;
